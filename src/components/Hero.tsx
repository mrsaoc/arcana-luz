  ...
  return (
    <section className="relative overflow-hidden pt-28 pb-20 md:pt-36 md:pb-28">
      ...
      <div className="container relative mx-auto px-4 md:px-8 text-center max-w-3xl">
        ...
        <button className="rounded-full bg-gradient-warm px-8 py-4 text-base font-extrabold text-accent-foreground shadow-glow-accent animate-pulse-glow hover:scale-105 transition-transform duration-300">
          Comienza tu prueba
        </button>
